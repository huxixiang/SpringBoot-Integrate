...
public class HttpAPIService {
     ...
     * @throws Exception
     */
    public String doGet(String url, Map<String, Object> params,Map<String,Object> header) throws Exception {
        URIBuilder uriBuilder = new URIBuilder(url);
     ...
     * @throws Exception
     */
    public HttpResult doPost(String url, Map<String, Object> params,Map<String,String>header) throws Exception {
        // 声明httpPost请求
